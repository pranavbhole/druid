...
public class CPUTimeMetricQueryRunner<T> implements QueryRunner<T>
{
  ...
  public Sequence<T> run(final QueryPlus<T> queryPlus, final ResponseContext responseContext)
  {
    ...
    if (queryWithMetrics.getQueryMetrics() instanceof QueryRuntimeAnalysis) {
      responseContext.addQueryAnalysis((QueryRuntimeAnalysis<?, ?>) queryWithMetrics.getQueryMetrics());
    }
